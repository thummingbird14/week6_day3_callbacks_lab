...
describe('Cinema', function () {
  ...
  it('should be able to get a list of film titles', function () {
    ...
    const list = ['Moonlight', 'Blade Runner 2049', 'Dunkirk', 'Black Panther', 'T2 Trainspotting'];
  ...
  it('should be able to filter films by genre', function(){
    ...
    const dramaFilms = [moonlight, trainspotting];
    assert.deepStrictEqual(actual, dramaFilms);
  });

  it('should be able to check whether there are some films from a particular year', function(){
    const actual = cinema.checkFilmsByYear(2017);
    const Films2017 = [bladeRunner, dunkirk, trainspotting];
    assert.deepStrictEqual(actual, Films2017);
  });
